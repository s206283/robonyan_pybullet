...
class Conv_QNetwork(nn.Module):
    def __init__(self, h, w, num_inputs, num_actions, hidden_dim):
        ...
        # Q2 Convnet
        self.conv4 = nn.Conv2d(num_inputs, 64, kernel_size=3, stride=2)
        self.bn4 = nn.BatchNorm2d(64)
        self.conv5 = nn.Conv2d(64, 64, kernel_size=3, stride=2)
        self.bn5 = nn.BatchNorm2d(64)
        self.conv6 = nn.Conv2d(64, 64, kernel_size=3, stride=2)
        self.bn6 = nn.BatchNorm2d(64)

        # compute outputsize of conv2d layers
        ...
        # Q1 architecture
        self.linear1 = nn.Linear(linear_input_size + num_actions, hidden_dim)
        self.linear2 = nn.Linear(hidden_dim, hidden_dim)
        self.linear3 = nn.Linear(hidden_dim, 1)

        # Q2 architecture
        self.linear4 = nn.Linear(linear_input_size + num_actions, hidden_dim)
        self.linear5 = nn.Linear(hidden_dim, hidden_dim)
        self.linear6 = nn.Linear(hidden_dim, 1)
    ...
    def forward(self, state, action):
        ...
        x2 = F.relu(self.bn4(self.conv4(state)))
